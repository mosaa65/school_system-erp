...
```mermaid
graph TD
    ATT["System 04<br/>الحضور والغياب"] -->|v_auto_attendance_score| MG["monthly_grades<br/>المحصلة الشهرية"]
    HW["DDL_HOMEWORKS<br/>الواجبات"] -->|v_auto_homework_score| MG
    EX["DDL_EXAMS<br/>الاختبارات"] -->|"exam_score"| MG
    T["المعلم"] -->|"يدوي"| ACT["activity_score<br/>درجة النشاط"]
    ACT --> MG
...
| العام الدراسي | `academic_year_id` | INT (FK) | **جديد (v4.0)** — للبحث السريع | 1 |
| الفصل الدراسي | `semester_id` | INT (FK) | **جديد (v4.0)** — للبحث السريع | 1 |
...
- **جديد (v4.0):** Trigger `trg_monthly_grades_validate_manual` يتحقق من أن الدرجات المدخلة يدوياً لا تتجاوز الحد الأقصى المحدد في السياسة.
