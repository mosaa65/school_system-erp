...
```mermaid
graph TD
    MG["monthly_grades<br/>المحصلات الشهرية"] -->|sp_calculate_semester_totals| SG["semester_grades<br/>نتيجة الفصل"]
    SG -->|sp_calculate_annual_results| AG["annual_grades 🆕<br/>نتيجة العام لكل مادة"]
    AG --> AR["annual_result 🆕<br/>النتيجة الشاملة + قرار النقل"]
    AR --> CERT["System 17<br/>الشهادات"]
